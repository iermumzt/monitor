...
window.IX = (function() {
  ...
  if (!("defaultView" in document)) document.defaultView = {};
  ...
  var typeUtils = {
    ...
    isArray: function(ob) {
      return (!!ob && ob instanceof Array);
    },
    isElement: function(el) {
      return el.nodeType === 1;
    },
    getClass: function(ob) {
  ...
  var browser = {
    versions: function() {
      ...
      return { //移动终端浏览器版本信息   	  
        ...
        ios9: u.match(/iPhone OS 9/i) || u.match(/iPhone OS 10/i),
        weixin: u.match(/micromessenger/gi)
      };
    }(),
  ...
  */
  ...
  var Brower = function checkIE() {
    ...
    var isLtIE9 = isIE5 || isIE6 || isIE7 || isIE8 || isIE9 || (isIE && document.compatMode !== 'CSS1Compat');
  ...
  var browserUtils = {
    ...
    getUrlParam: function(key, defV) {
      ...
      for (var i = 0; i < len; i += 1) {
        var _p = paramList[i];
        if (_p.indexOf(key + "=") == 0)
          return _p.substring(key.length + 1); //decodeURIComponent(_p.substring(key.length+1));
      }
      return defV;
    },
    ...
    bind: function(el, handlers) {
      _bindHandlers(el, handlers, true);
    },
  ...
  var checkReadyFn = function(condFn, execFn, period, _config) {
    ...
    var maxAge = $XP(_config, "maxAge", null),
      expireFn = $XF(_config, "expire"),
      startTick = null;
    if (isNaN(maxAge))
      maxAge = null;
  ...
  var ifRectIntersect = function(_rect1, _rect2) {
    return Math.abs(_rect1.maxx + _rect1.minx - _rect2.minx - _rect2.maxx) <= _rect2.maxx - _rect2.minx + _rect1.maxx - _rect1.minx && Math.abs(_rect1.maxy + _rect1.miny - _rect2.miny - _rect2.maxy) <= _rect2.maxy - _rect2.miny + _rect1.maxy - _rect1.miny;
  };
...
IX.Array = (function() {
  ...
  _self = {
    ...
    sort: function(arr, cmpFn) {
      var arr1 = IX.map(arr, function(item) {
        return item;
      });
      return arr1.sort(cmpFn);
    },
    sortArray: function(arr, cmpFn) {
      var temp;
    ...
    isSameSet: function(_arr1, _arr2, equalFn) {
      var arr1 = _self.toSet(_arr1),
        arr2 = _self.toSet(_arr2);
    ...
    compact: function(arr, validFn) {
      var fn = IX.isFn(validFn) ? validFn : function(item) {
        return item;
      };
      return IX.loop(arr, [], function(acc, item) {
        if (fn(item))
...
IX.I1ToNManager = function(eqFn) {
  var _eqFn = IX.isFn(eqFn) ? eqFn : function(item, value) {
    return item == value;
  };
...
IX.IListManager = function() {
  ...
  var listFn = function(keys) {
    return IX.map(keys, function(item) {
  ...
  return IX.inherit(_super, {
    ...
    iterate: function(fn) {
      IX.iterate(_list.getList(), function(item) {
        fn(_super.get(item));
      });
    },
    getFirst: function() {
...
IX.Date = (function() {
  ...
  var fields4Day = ["FullYear", "Month", "Date"],
    fields4Time = ["Hours", "Minutes", "Seconds"];
  var ds = "-",
    ts = ":";
...
IX.win = (function() {
  ...
  return {
    ...
    bind: function(handlers) {
      return _bindHandlers(handlers, true);
    },
    /**
     * handlerIds {
     * 		click : handlerId1,
     ...
     * }
     */
    unbind: function(handlerIds) {
      _bindHandlers(handlerIds, false);
    },
...
(function() {
  function defaultParamFn(_name, _params) {
    return _params;
  }

  function defaulRspFn(data, cbFn) {
    IX.isFn(cbFn) && cbFn(data);
  }
  ...
  function ajaxRouteFn(callerRouteDef) {
    return {
      channel: $XP(callerRouteDef, "channel", callerRouteDef.name + IX.UUID.generate()),
  ...
  function AjaxCaller(routes, actionType, _ajaxFn, urlFac) {
    ...
    var c = function(_name, params, cbFn, failFn) {
      ...
      _ajaxFn({
        ...
        success: function(data) {
          ...
          if (Entos.EventRoute) {
            Entos.EventRoute.fire(actionType + "_" + _name, {
  ...
  function UrlEngine(ifAjax) {
    ...
    return IX.inherit({
       ...
       */
      createCaller: function(routes, actionType) {
        return new AjaxCaller(routes, actionType, function(ajaxParam) {
...
IX.Dom = (function() {
  ...
  var textFn = IX.isMSIE ? function(node) {
  ...
  return {
    ...
    removeStyle: function(_domElem, _style) {
      _domElem.style[IX.getClass(document.body.style) != "object" ? "removeProperty" : "removeAttribute"](_style);
    },
...
IX.HtmlDocument = (function() {
  ...
  var getStyle = function(_elem, styles) {
    ...
    if (styles == "opacity") {
      ...
      if (_value == "auto" && IX.Array.indexOf(["width", "height"], function(_i) {
          return styles == _i;
  ...
  return {
    ...
    getWindowScreen: function() {
      var body = IX.isFirefox ? document.documentElement : document.body;
      var win = window;
    ...
    getScroll: function(_dom) {
      ...
      return {
        scrollTop: _window.pageYOffset || _window.document.documentElement.scrollTop || _window.document.body.scrollTop || 0,
        scrollLeft: _window.pageXOffset || _window.document.documentElement.scrollLeft || _window.document.body.scrollLeft || 0
      };
    },
...
(function() {
  ...
  var regSplit = function(str, reg) {
    var _splitArr = [],
      _matchArr = str.match(reg),
      _len = _matchArr ? _matchArr.length : 0;
    for (var i = 0; i < _len; i++) {
      var _arr = _matchArr[i],
        _idx = str.indexOf(_arr);
      if (_idx == -1)
        continue;
  ...
  var parseTpl = function(tplstr) {
    var tplMgr = {};
    var newTpl = function(name, html) {
      tplMgr[name] = {
        name: name,
        tpl: [html]
      };
    };
    var appendTpl = function(name, html) {
      tplMgr[name].tpl.push(html);
    };
    ...
    var tplArr = _regSplit.arr,
      contentArr = _regSplit.separate;
  ...
  IX.ITemplate = function(config) {
    ...
    return IX.inherit({
      render: function(tplId) {
        return _render(tplId);
      },
      renderData: function(tplId, data) {
        return _render(tplId, data);
      },
      destroy: function() {
        tplMgr.destroy();
        tplMgr = null;
  ...
  var PhonePattern = /^1[3-9][0-9]\d{4,8}$/;
  var EmailPattern = /^[_a-zA-Z0-9.]+[\-_a-zA-Z0-9.]*@(?:[_a-zA-Z0-9]+\.)+[a-zA-Z0-9]{2,4}$/;
  var MobilePhonePattern = /^1[3-9][0-9]\d{8}$/;
  ...
  IX.extend(String.prototype, {
    ...
    loopReplace: function(varr) {
      return IX.loop(varr, this, function(acc, item) {
    ...
    stripScripts: function() {
      return this.replace(ScriptPattern, '');
    },
    stripFormTag: function() {
      return this.replace(FormPattern, '');
    },
    strip: function() {
      return this.replace(/^\s+/, '').replace(/\s+$/, '');
    },
    substrByLength: function(len) {
      return substrByLength(this.toString(), len);
    },
    isSpaces: function() {
      return (this.replace(/(\n)|(\r)|(\t)/g, "").strip().length == 0);
    },
    ...
    isEmail: function() {
      return !IX.isEmpty(this) && EmailPattern.exec(this);
    },
    isMobilePhone: function() {
      return !IX.isEmpty(this) && MobilePhonePattern.exec(this);
    },
    isPhone: function() {
      return !IX.isEmpty(this) && PhonePattern.exec(this);
    },
    ...
    tail: function(len) {
      return (this.length > len) ? (this.substring(this.length - len)) : this;
    },
    ...
    multi: function(len) {
      return IX.Array.init(len, this).join("");
    },

    pickUrls: function() {
      return this.match(UrlRegEx);
    },
    replaceUrls: function(_r, _f) {
      return this.replace(_r || UrlRegEx, _f || function(a) {
        return '<a href="' + a + '" target="_blank">' + a + '</a>';
      });
    },
    regSplit: function(reg) {
      return regSplit(this, reg);
    },

    pick4Replace: function() {
      return this.match(ReplaceKeyPattern);
    },
    ...
    inPureTag: function(tagN, attrs) {
      return IX.Dom.inPureTag(tagN, this, attrs);
    },
    inTag: function(tagN, attrs) {
      return IX.Dom.inTag(tagN, this, attrs);
    },
...
IX.Util.Date = function(timeInSecond) {
  ...
  return {
    ...
    toTime: function() {
      return [time[3], time[4]].join(":");
    },
    toShort: function() {
      var ds = IX.Date.getDS(),
        ts = IX.Date.getTS();
      var curTime = getFieldValues(new Date());
      var strs = new Array();
