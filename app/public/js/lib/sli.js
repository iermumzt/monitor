...
;(function ($,window,document,undefined) {
    ...
    SliderUnlock.prototype.move = function () {
        ...
        if ((me.index + me.labelWidth) >= me.max) {
            ...
            me.swipestart = false;
            endTime = me.nowTime();
            sliderTime = endTime-startTime;
            sliderWidth = me.index;
            $.ajax(
                {
                    type: "GET",
                    url:me.baseUrl,
                    ...
                    dataType: 'json',
                    async:false,//取消异步请求
                    data:{method:'checkcode',maxwidth:me.max,slidertime:sliderTime,sliderwidth:sliderWidth},
    ...
    SliderUnlock.prototype.nowTime = function (){
